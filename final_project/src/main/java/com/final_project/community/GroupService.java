...
public interface GroupService {
	...
	public GroupBoard readGroupBoard(int gbNum); // 그룹의 게시판읽기
	public int updateHitCount(int gbNum); // 그룹의 게시판 조회수 
	...
	public int deleteGroupBoard(int gbNum, String pathname, String mId); // 그룹의 게시판 삭제
	
	public int insertLikeGroupBoard(GroupBoard dto); // 그룹의 게시판좋아요추가
	public int countLikeGroupBoard(int gbNum); // 그룹의 게시판좋아요갯수
	...
	public List<GroupBoardReply> listReplyAnswer(int answer); // 댓글의 댓글 리스트
