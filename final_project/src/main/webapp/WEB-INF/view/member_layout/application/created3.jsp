...
<div class="myInquiry-list-body">
	<h3>
		<c:if test="${mode!='update'}">
			...
			<small style="font-family: 'Gudea', sans-serif; letter-spacing: 3px; margin-left: 5px; font-size: 16px; font-weight: bold; color: #6d6b6b;">Write application (3step)</small>
		</c:if>
		<c:if test="${mode=='update'}">
			이력서 작성 (1단계 > 2단계 > <b>3단계</b>)
