...
3. 도구 -> 인터넷 옵션 -> 보안설정에서 [기본 수준] 으로 선택하신 후 인터넷 옵션 -> 개인정보> 편집 -> -> 허용 버튼 클릭해 주세요. <br>
...
(2) 신뢰할 수 있는 사이트 > 사이트 버튼 클릭 후 추가하여 등록해 주세요. <br>
(3) 인터넷 옵션 창의 [확인] 버튼을 클릭하세요. <br>
(4) 띄워놓았던 인터넷 브라우저를 모두 닫고 새로 인터넷 브라우저를 열어 로그인을 해주세요. <br>
<br>
3. 제한된 사이트에서 해지 <br>
(1) 브라우저 실행 > 도구 > 인터넷 옵션 > 보안 > 제한된 사이트 클릭하고 [사이트] 버튼을 클릭해 주세요. <br>
(2) 제한된 사이트로  등록되어 있다면, 선택하신 후 우측의 [제거] 버튼을 클릭해 주세요. <br>
(3) 인터넷 옵션 창의 [확인] 버튼을 클릭하세요. <br>
(4) 띄워놓았던 인터넷 브라우저를 모두 닫고 새로 인터넷 브라우저를 열어  로그인을 해주세요. <br>
<br>
<br>
위 항목에 해당하지 않는 경우 고객센터로 문의주시면 확인 후 안내 드리도록 하겠습니다. <br>
<br>
...
· 면접제의·입사요청 기업: HOME > 개인회원 > 입사지원 관리 > 면접제의·입사요청 기업<br>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse8" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading8">
      <div class="panel-body">
<br>
 온라인 입사지원 시스템을 이용하여 채용공고에 입사지원을 한 경우, 모든 입사지원 내역을 취업활동증명서로 발급 받을 수 있으며 발급비용은 무료입니다. <br>
<br>
아래의 내용에 유의하여 신청하시면 됩니다. <br>
<br>
1. 최근 90일 이내의 입사지원 내역만 조회/발급이 가능. <br>
<br>
 90일 이전의 입사지원 내역을 보관하지 않으며, 90일 이전의 취업활동증명서는 효력이 없습니다. 실업급여 등의 목적이 아닌 개인적 취업활동 내역을 관리하실 분은 90일 이전에 별도의 기록을 해 두시기 바랍니다. <br>
<br>
2.온라인 입사지원 시스템을 통한 입사지원만 발급 가능. <br>
<br>
홈페이지, 우편, FAX, 방문접수를 통해 입사지원을 한 경우  해당 기업에 발급을 요청해야 합니다. 이는 시스템에 기록이 남지 않는 개인적 활동으로 분류되기 때문에 취업활동에 대한 증명을 해드릴 수가 없습니다. 또한, 비회원 입사지원으로 입사지원 한경우도 마찬가지로 개인적 활동으로 분류되어 취업활동 증명이 되지 않으니 유의 하시기 바랍니다. <br>
<br>
3. 지원취소/입사지원 내역 삭제 등은 발급 불가. <br>
<br>
입사지원 후 지원을 취소하거나 입사지원 내역을 삭제한 경우 취업활동증명서 발급이 불가능 합니다.  취업활동증명서는 개인의 입사지원 내역을 근거로 취업활동증명서를 발급하는데 이에 대한 근거자료가 취소/삭제의 경우로 사라진다면 발급이 되지 않습니다. <br>
<br>
...
<br>
   ...
   <div class="panel panel-default">
    ...
    <div id="collapse9" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading9">
      <div class="panel-body">
        온라인 입사지원을 한 경우 해당 기업·서치펌·파견대행 기업은  온라인 채용관리 시스템의 온라인 인재관리에서 지원자의 이력서의 이력서를 확인하게 되며, 개인회원은 이력서 열람여부를 실시간으로 확인할 수 있습니다. <br>
<br>
...
1. 다른 응용프로그램을 모두 닫으신 후 한 개의 익스플로러만 열어주세요. <br>
2. 도구 >인터넷옵션> 일반 에서 가운데 임시 인터넷 파일 부분의 [설정]을 클릭하셔서 저장된 페이지의 새버전확인을 [자동으로 ==> 페이지 열때마다]로 변경해 주세요. <br>
3. 도구 -> 인터넷 옵션 -> 보안설정에서 [기본 수준] 으로 선택하신 후 인터넷 옵션 -> 개인정보> 편집 ->  입력 -> 허용 버튼 클릭해 주세요. <br>
4. 임시 인터넷 파일의 [파일삭제]버튼을 클릭하셔서 캐쉬에 남은 페이지들을 모두 삭제해 주세요. <br>
<br>
또한 PC에 보안프로그램이나 방화벽이 설치되어 있는지 확인(사내 시스템관리자가 알고 있음) 해주시기 바랍니다. <br>
<br>
...
2. 보안 수정 재설정 <br>
(1) 브라우저 실행 > 도구 > 인터넷 옵션 > 보안 > 인터넷 메뉴를 클릭하고, 보안 수준을 [기본 수준] 클릭해 주세요. <br>
(2) 신뢰할 수 있는 사이트 > 사이트 버튼 클릭 후  등록해 주세요. <br>
(3) 인터넷 옵션 창의 [확인] 버튼을 클릭하세요. <br>
(4) 띄워놓았던 인터넷 브라우저를 모두 닫고 새로 인터넷 브라우저를 열어  로그인을 해주세요. <br>
<br>
3. 제한된 사이트에서 해지 <br>
...
1. 다른 응용프로그램을 모두 닫으신 후 한 개의 익스플로러만 열어주세요. <br>
2. 도구 >인터넷옵션> 일반 에서 가운데 임시 인터넷 파일 부분의 [설정]을 클릭하셔서 저장된 페이지의 새버전확인을 [자동으로 ==> 페이지 열때마다]로 변경해 주세요. <br>
3. 도구 -> 인터넷 옵션 -> 보안설정에서 [기본 수준] 으로 선택하신 후 인터넷 옵션 -> 개인정보> 편집 ->  버튼 클릭해 주세요. <br>
4. 임시 인터넷 파일의 [파일삭제]버튼을 클릭하셔서 캐쉬에 남은 페이지들을 모두 삭제해 주세요. <br>
<br>
또한 PC에 보안프로그램이나 방화벽이 설치되어 있는지 확인(사내 시스템관리자가 알고 있음) 해주시기 바랍니다. <br>
<br>
...
회사나 학교 PC는 방화벽이 설치되어 있을경우 일부기능을 이용하지 못하거나 접속이 어려울 수 있습니다. 
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse17" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading17">
      <div class="panel-body">
         회원탈퇴는 아래 절차에 따라 진행하실 수 있습니다. <br>
<br>
1단계. 회원 로그인 후 고객센터 [회원탈퇴 신청]을 클릭해 주세요. <br>
<br>
2단계. 탈퇴 전 유의 사항을 반드시 확인 하신 후 탈퇴 신청폼을 작성해 주세요. <br>
...
3. 제한된 사이트에서 해지 <br>
(1) 브라우저 실행 > 도구 > 인터넷 옵션 > 보안 > 제한된 사이트 클릭하고 [사이트] 버튼을 클릭해 주세요. <br>
(2) 제한된 사이트로 가 등록되어 있다면, 선택하신 후 우측의 [제거] 버튼을 클릭해 주세요. <br>
(3) 인터넷 옵션 창의 [확인] 버튼을 클릭하세요. <br>
(4) 띄워놓았던 인터넷 브라우저를 모두 닫고 새로 인터넷 브라우저를 열어  로그인을 해주세요. <br>
<br>
<br>
...
1. 다른 응용프로그램을 모두 닫으신 후 한 개의 익스플로러만 열어주세요. <br>
2. 도구 >인터넷옵션> 일반 에서 가운데 임시 인터넷 파일 부분의 [설정]을 클릭하셔서 저장된 페이지의 새버전확인을 [자동으로 ==> 페이지 열때마다]로 변경해 주세요. <br>
3. 도구 -> 인터넷 옵션 -> 보안설정에서 [기본 수준] 으로 선택하신 후 인터넷 옵션 -> 개인정보> 편집 -> 세요. <br>
4. 임시 인터넷 파일의 [파일삭제]버튼을 클릭하셔서 캐쉬에 남은 페이지들을 모두 삭제해 주세요. <br>
<br>
또한 PC에 보안프로그램이나 방화벽이 설치되어 있는지 확인(사내 시스템관리자가 알고 있음) 해주시기 바랍니다. <br>
<br>
