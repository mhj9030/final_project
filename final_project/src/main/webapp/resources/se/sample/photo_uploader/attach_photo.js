    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/final_project/image/html5Upload'; 	//upload URL
	...
	function onAjaxError (){
		...
		alert("업로드 중 문제가 발생했습니다. 죄송하지만 다시한번 시도해주세요!!");
	}
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/final_project/image/generalUpload',	//샘플 URL입니다.
